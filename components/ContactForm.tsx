  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <select id="inquiryType" name="inquiryType" required defaultValue={defaultInquiryType} className={inputClass}>
      ...
      <div>
        ...
        <textarea id="message" name="message" required rows={5} defaultValue={defaultMessage} className={inputClass + " resize-none"} placeholder="Tell us about your family and how we can help…" />
      </div>
